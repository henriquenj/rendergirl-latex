...
\caption{Kitchens: It contains 203.644 vertices, 405.242 triangles
...
\caption{Whale: A scene with a single whale object containing 8.432
  vertices and 16.764 triangles.}
\end{figure*}
\end{frame}
...
\caption{Cabin: It contains 93.570, 178.104 triangles divided into 250
  objects}
\end{figure*}
\end{frame}
