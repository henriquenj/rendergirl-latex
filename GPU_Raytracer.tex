...
\teaser{
  \includegraphics[width=2.5in]{several_kitchen.png}
...
\begin{axis}[
    ...
    legend entries={Scene1, Scene2,Scene3},
    % TODO: fix scientific notation
    % TODO: increase size
]
% scene 1
\addplot[
    color=black,mark=* size=1.5,dashed,nodes near coords
    ]
    coordinates {(500,0.0624)(1000, 0.1250)(1500,0.2187)(2000,0.3743)};
% scene 2
\addplot[
    color=red,mark=*,dashed,nodes near coords
    ]
    coordinates {(500,0.2968)(1000, 0.3750)(1500,0.5014)(2000,0.6951)};
%scene 3
\addplot[
    color=blue,mark=*,dashed,nodes near coords
    ]
    coordinates {(500,0.2031)(1000, 0.8291)(1500,1.8753)(2000,3.2270)};
...
\addplot[
    ...
    coordinates {(1,0.0781)(4, 0.0624)(8,0.0624)};
\addplot[
    color=red,mark=*,dashed,nodes near coords
    ]
    coordinates {(1,0.1249)(4, 0.4531)(8,1.0672)};
